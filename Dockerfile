...
CMD ["sh", "-c", "python manage.py migrate --noinput && python manage.py collectstatic --noinput && gunicorn prode.wsgi:application --bind 0.0.0.0:8000 --workers 5 --threads 5"]
